...
const Shipment: NextPage = () => {
  ...
  function handleChoosingPayment() {
    let lanjut = true;
    if (currAddress?.id === undefined || currAddress?.id === "") {
      lanjut = false;
    }
    checkoutData?.getUserCheckedCart
      ?.map((cart: any) => cart?.product?.shop)
      ...
      .map((shop: any) => {
        if (
          chosenShipment[shop?.id] === undefined ||
          chosenShipment[shop?.id] === ""
        ) {
          lanjut = false;
        }
      });
    if (lanjut == false) {
      addToast("Harus pilih address dan opsi pengiriman", {
        appearance: "error",
      });
    }
    if (lanjut == true) {
                  ...
                  <div className={styles.checkout_address_inner_container}>
                    ...
                    <div className={styles.checkout_address_main_container}>
                      <div>
                        ...
                        >
                          <b className={styles.checkout_address_label_receiver}>
                      ...
                      <div className={styles.checkout_address_detail_container}>
                        <div className={styles.checkout_address_detail}>
                          {currAddress?.address}
                        </div>
                      </div>
                    </div>
                    <div className={styles.checkout_address_options_container}>
                      <button
